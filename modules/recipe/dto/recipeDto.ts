...
export const GetRecipeByIdDtoSchema = z.object({
	id: z.uuid("An id is required"),
});

export const GetRecipeByIdInputSchema = GetRecipeByIdDtoSchema;
...
export type GetRecipeByIdDto = z.infer<typeof GetRecipeByIdDtoSchema>;
